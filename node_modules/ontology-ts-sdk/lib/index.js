...
/*!*****************************!*\
  !*** ./src/crypto/Ecies.ts ***!
  \*****************************/
/*! exports provided: Ecies */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ecies", function() { return Ecies; });
...
/* harmony import */ var pkcs7__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! pkcs7 */ "pkcs7");
/* harmony import */ var pkcs7__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pkcs7__WEBPACK_IMPORTED_MODULE_2__);
/*
 * Copyright (C) 2018 The ontology Authors
 * This file is part of The ontology library.
 *
...
class Ecies {
    ...
    constructor(Curve) {
        ...
        this.ec = new elliptic__WEBPACK_IMPORTED_MODULE_1__["ec"](curve);
    ...
    enc(pubkey, msg, keylen, _iv) {
        ...
        const derivedKeyArray = this.kdf2(seed, keylen * 8, this.digestSize, this.hashAlg);
        if (!derivedKeyArray) {
            return;
        }
        ...
        if (!_iv) {
            ...
            crypto__WEBPACK_IMPORTED_MODULE_0__["randomFillSync"](iv);
        } else {
            iv = Buffer.from(_iv, 'hex');
        }
        const algorithm = this.encAlg;
        const cipher = crypto__WEBPACK_IMPORTED_MODULE_0__["createCipheriv"](algorithm, derivedKey, iv);
        cipher.setAutoPadding(false);
        const msgCipher = cipher.update(pkcs7__WEBPACK_IMPORTED_MODULE_2__["pad"](msg), 'binary', 'hex') + cipher.final('hex');
        return {
            iv: iv.toString('hex'),
            out,
            msgCipher
    ...
    dec(msgCipher, out, iv, keylen) {
        ...
        const algorithm = this.encAlg;
        const decipher = crypto__WEBPACK_IMPORTED_MODULE_0__["createDecipheriv"](algorithm, derivedKey, iv2);
        decipher.setAutoPadding(false);
        const plain = decipher.update(msgCipher, 'hex', 'binary') + decipher.final('binary');
        // un padding
        const unpad = pkcs7__WEBPACK_IMPORTED_MODULE_2__["unpad"](Buffer.from(plain, 'binary'));
        return Buffer.from(unpad);
    }
    /* utils */
    kdf2(seed, len, digestSize, hashFunc) {
        if (len < 0) {
            return [];
        }
        ...
        let hashIns;
        while (counter < b) {
            hashIns = crypto__WEBPACK_IMPORTED_MODULE_0__["createHash"](hashFunc);
            const h = hashIns.update(Buffer.concat([seed, this.I2OSP(counter, 4)])).digest();
            key[counter - 1] = Buffer.alloc(offset);
            key[counter - 1] = h;
            counter++;
        }
        hashIns = crypto__WEBPACK_IMPORTED_MODULE_0__["createHash"](hashFunc);
        const hEnd = hashIns.update(Buffer.concat([seed, this.I2OSP(counter, 4)])).digest();
        key[counter - 1] = Buffer.alloc(offset);
        key[counter - 1] = hEnd;
        return key;
    }
...
/* harmony import */ var base_58__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! base-58 */ "base-58");
...
function hexToBase58(hexEncoded) {
    ...
    return base_58__WEBPACK_IMPORTED_MODULE_0__["encode"](new Buffer(datas, 'hex'));
}
function base58ToHex(base58Encoded) {
    const decoded = base_58__WEBPACK_IMPORTED_MODULE_0__["decode"](base58Encoded);
...
/*!*****************************!*\
  !*** ./src/crypto/index.ts ***!
  \*****************************/
/*! exports provided: Address, KeyType, CurveLabel, SignatureScheme, KeyParameters, PrivateKey, registerKeyDeserializer, PublicKey, PublicKeyStatus, Signature, Issuer, User, Ecies */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Ecies__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Ecies */ "./src/crypto/Ecies.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Ecies", function() { return _Ecies__WEBPACK_IMPORTED_MODULE_10__["Ecies"]; });
...
function encryptWithEcb(privateKey, publicKeyEncoded, keyphrase, scryptParams = _consts__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_SCRYPT"]) {
    ...
    // console.log( "assembled: ", assembled );
    return base_58__WEBPACK_IMPORTED_MODULE_0__["encode"](Buffer.from(assembled, 'hex'));
}
/**
...
function decryptWithEcb(encryptedKey, keyphrase, scryptParams = _consts__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_SCRYPT"]) {
    const assembled = Object(_utils__WEBPACK_IMPORTED_MODULE_8__["ab2hexstring"])(base_58__WEBPACK_IMPORTED_MODULE_0__["decode"](encryptedKey));
    // console.log( "assembled: ", assembled );
...
/* harmony import */ var _network_websocket_websocketClient__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../network/websocket/websocketClient */ "./src/network/websocket/websocketClient.ts");
/* harmony import */ var _scrypt__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../scrypt */ "./src/scrypt.ts");
/* harmony import */ var _smartcontract_abi_abiInfo__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../smartcontract/abi/abiInfo */ "./src/smartcontract/abi/abiInfo.ts");
/* harmony import */ var _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../smartcontract/abi/parameter */ "./src/smartcontract/abi/parameter.ts");
/* harmony import */ var _smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../smartcontract/nativevm/ontAssetTxBuilder */ "./src/smartcontract/nativevm/ontAssetTxBuilder.ts");
/* harmony import */ var _smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../smartcontract/nativevm/ontidContractTxBuilder */ "./src/smartcontract/nativevm/ontidContractTxBuilder.ts");
/* harmony import */ var _smartcontract_neovm_oep8TxBuilder__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../smartcontract/neovm/oep8TxBuilder */ "./src/smartcontract/neovm/oep8TxBuilder.ts");
/* harmony import */ var _transaction_ddo__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../transaction/ddo */ "./src/transaction/ddo.ts");
/* harmony import */ var _transaction_transaction__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../transaction/transaction */ "./src/transaction/transaction.ts");
/* harmony import */ var _transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../transaction/transactionBuilder */ "./src/transaction/transactionBuilder.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../utils */ "./src/utils.ts");
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../wallet */ "./src/wallet.ts");
/* harmony import */ var _crypto_Ecies__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./../crypto/Ecies */ "./src/crypto/Ecies.ts");
/* harmony import */ var _smartcontract_neovm_oep4TxBuilder__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./../smartcontract/neovm/oep4TxBuilder */ "./src/smartcontract/neovm/oep4TxBuilder.ts");
/*
* Copyright (C) 2018 The ontology Authors
* This file is part of The ontology library.
*
...
class SDK {
    ...
    static setSocketPort(port) {
        if (port) {
            ...
            SDK.socketClient = new _network_websocket_websocketClient__WEBPACK_IMPORTED_MODULE_12__["WebsocketClient"](`ws://${SDK.SERVER_NODE}:${SDK.SOCKET_PORT}`);
            return;
        }
    ...
    static transformPassword(password) {
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_22__["isBase64"])(password)) {
            return Buffer.from(password, 'base64').toString();
        }
        return password;
    }
    static createWallet(name, password, payer, gasPrice, gasLimit, callback) {
        const wallet = _wallet__WEBPACK_IMPORTED_MODULE_23__["Wallet"].create(name);
        ...
        const publicKey = privateKey.getPublicKey();
        const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_17__["buildRegisterOntidTx"])(identity.ontid, publicKey, gasPrice, gasLimit);
        tx.payer = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](payer);
        Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["signTransaction"])(tx, privateKey);
        ...
        return restClient.sendRawTransaction(tx.serialize(), true).then(res => {
            ...
            if (res.Result.Result === '01') {
                ...
                if (callback) {
                    Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(errResult), callback);
                }
                return errResult;
            }
        }).catch(err => {
    ...
    static importIdentityWithPrivateKey(label = '', privateKey, password, callback) {
        ...
        password = this.transformPassword(password);
        if (!privateKey || privateKey.length !== 64 || !Object(_utils__WEBPACK_IMPORTED_MODULE_22__["isHexString"])(privateKey)) {
            const obj = {
                error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].INVALID_PARAMS,
                result: ''
            };
            callback && Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(obj), callback);
            return obj;
        }
        let obj;
        const pri = new _crypto__WEBPACK_IMPORTED_MODULE_5__["PrivateKey"](privateKey);
        const identity = _identity__WEBPACK_IMPORTED_MODULE_7__["Identity"].create(pri, password, label);
        obj = {
            error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
            result: identity.toJson()
        };
        const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_17__["buildGetDDOTx"])(identity.ontid);
        const restClient = new _network_rest_restClient__WEBPACK_IMPORTED_MODULE_11__["default"](`http://${SDK.SERVER_NODE}:${SDK.REST_PORT}`);
        return restClient.sendRawTransaction(tx.serialize(), true).then(res => {
    ...
    static importIdentityWithWif(label = '', wif, password, callback) {
        ...
        let pri;
        try {
            pri = _crypto__WEBPACK_IMPORTED_MODULE_5__["PrivateKey"].deserializeWIF(wif);
        } catch (err) {
            const obj = {
                error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].INVALID_PARAMS,
                result: ''
    ...
    static importIdentityWithWifOffChain(label = '', wif, password, callback) {
        wif = wif.trim();
        password = this.transformPassword(password);
        let obj;
        let pri;
    ...
    static importIdentityWithWallet(label, encryptedPrivateKey, password, address, salt, callback) {
        ...
        const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_17__["buildGetDDOTx"])(identity.ontid);
        const param = Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["buildRestfulParam"])(tx);
        const restUrl = `http://${SDK.SERVER_NODE}:${SDK.REST_PORT}`;
        const url = Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["sendRawTxRestfulUrl"])(restUrl, true);
        // clear privateKey and password
        password = '';
    ...
    static importIdentityAndCreateWallet(label, encryptedPrivateKey, password, address, salt, callback) {
        ...
        try {
            ...
            const addr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](address);
            identity = _identity__WEBPACK_IMPORTED_MODULE_7__["Identity"].importIdentity(label, encryptedPrivateKeyObj, password, addr, salt);
            const wallet = _wallet__WEBPACK_IMPORTED_MODULE_23__["Wallet"].create(identity.label);
            wallet.defaultOntid = identity.ontid;
            wallet.addIdentity(identity);
            ...
            if (callback) {
                Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(error), callback);
            }
    ...
    static createAccount(label, password, callback) {
        // generate mnemnic
        let mnemonic = Object(_utils__WEBPACK_IMPORTED_MODULE_22__["generateMnemonic"])();
        password = this.transformPassword(password);
        const mnemonicHex = Object(_utils__WEBPACK_IMPORTED_MODULE_22__["str2hexstr"])(mnemonic);
        ...
        const mnemonicEnc = _scrypt__WEBPACK_IMPORTED_MODULE_13__["encryptWithGcm"](mnemonicHex, addr, salt, password);
    ...
    static decryptMnemonicEnc(mnemonicEnc, address, salt, password, callback) {
        ...
        const decMneHex = _scrypt__WEBPACK_IMPORTED_MODULE_13__["decryptWithGcm"](mnemonicEnc, addr, saltHex, password);
        const decMne = Object(_utils__WEBPACK_IMPORTED_MODULE_22__["hexstr2str"])(decMneHex);
        obj = {
            error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
            result: decMne
        };
    ...
    static signSelfClaim(context, claimData, ontid, encryptedPrivateKey, password, address, salt, callback) {
        ...
        const metadata = {
            issuer: ontid,
            subject: ontid,
            issuedAt: Object(_utils__WEBPACK_IMPORTED_MODULE_22__["now"])()
        };
    ...
    static getClaim(claimId, context, issuer, subject, encryptedPrivateKey, password, address, salt, payer, gasPrice, gasLimit, callback) {
        ...
        const attr = new _transaction_ddo__WEBPACK_IMPORTED_MODULE_19__["DDOAttribute"]();
        attr.key = path;
        attr.type = 'JSON';
        attr.value = value;
        const publicKey = privateKey.getPublicKey();
        const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_17__["buildAddAttributeTx"])(subject, [attr], publicKey, gasPrice, gasLimit);
        tx.payer = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](payer);
        Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["signTransaction"])(tx, privateKey);
        const restClient = new _network_rest_restClient__WEBPACK_IMPORTED_MODULE_11__["default"](`http://${SDK.SERVER_NODE}:${SDK.REST_PORT}`);
        return restClient.sendRawTransaction(tx.serialize(), true).then(res => {
    ...
    static transferAssets(token, from, to, value, encryptedPrivateKey, password, salt, gasPrice, gasLimit, payer, callback) {
        ...
        const tx = Object(_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__["makeTransferTx"])(token, fromAddress, toAddress, value, gasPrice, gasLimit);
        tx.payer = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](payer);
        Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["signTransaction"])(tx, privateKey);
        const result = {
            error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
            result: '',
            tx: tx.serialize(),
            txHash: Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(tx.getSignContent())
        };
        callback && Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(result), callback);
        // clear privateKey and password
        privateKey.key = '';
        password = '';
        return result;
    ...
    static claimOng(address, value, encryptedPrivateKey, password, salt, gasPrice, gasLimit, payer, callback) {
        ...
        const tx = Object(_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__["makeWithdrawOngTx"])(addressObj, addressObj, value, new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](payer), gasPrice, gasLimit);
        Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["signTransaction"])(tx, privateKey);
        const result = {
            error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
            result: '',
    ...
    static exportIdentityToQrcode(identityDataStr, callback) {
        ...
        if (!Object(_utils__WEBPACK_IMPORTED_MODULE_22__["isBase64"])(salt)) {
    ...
    static getUnclaimedOng(address, callback) {
        const restClient = new _network_rest_restClient__WEBPACK_IMPORTED_MODULE_11__["default"](`http://${SDK.SERVER_NODE}:${SDK.REST_PORT}`);
        return restClient.getAllowance('ong', new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__["ONT_CONTRACT"]), new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](address)).then(res => {
            const result = {
                error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
                result: res.Result
            };
    ...
    static createSharedWallet(requiredSignatureNum, allRelatedPks, callback) {
        ...
        try {
            ...
            pubs = pks.map(p => _crypto__WEBPACK_IMPORTED_MODULE_5__["PublicKey"].deserializeHex(new _utils__WEBPACK_IMPORTED_MODULE_22__["StringReader"](p)));
        } catch (err) {
            error = _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].INVALID_PARAMS;
        }
    ...
    static adderssFromPublicKey(publicKey, callback) {
        const pk = _crypto__WEBPACK_IMPORTED_MODULE_5__["PublicKey"].deserializeHex(new _utils__WEBPACK_IMPORTED_MODULE_22__["StringReader"](publicKey));
    ...
    static makeMultiSignTransaction(asset, from, to, amount, gasPrice, gasLimit, callback) {
        ...
        const tx = Object(_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_16__["makeTransferTx"])(asset, fromAddress, toAddress, amount, gasPrice, gasLimit);
    ...
    static signMultiAddrTransaction(encryptedPrivateKey, address, salt, password, allRelatedPks, requiredSignatureNum, txDada, callback) {
        ...
        const M = parseInt(requiredSignatureNum, 10);
        const tx = _transaction_transaction__WEBPACK_IMPORTED_MODULE_20__["Transaction"].deserialize(txDada);
        const pubs = JSON.parse(allRelatedPks);
        const pks = pubs.map(p => new _crypto__WEBPACK_IMPORTED_MODULE_5__["PublicKey"](p));
        Object(_transaction_transactionBuilder__WEBPACK_IMPORTED_MODULE_21__["signTx"])(tx, M, pks, privateKey);
        const result = {
            error: _error__WEBPACK_IMPORTED_MODULE_6__["ERROR_CODE"].SUCCESS,
    ...
    static neoTransfer(from, to, value, encryptedPrivateKey, password, salt, callback, params) {
        ...
        const addr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](from);
        const abiInfo = _smartcontract_abi_abiInfo__WEBPACK_IMPORTED_MODULE_14__["default"].parseJson(NEP5_ABI);
        const contractAddr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(CONTRACT_HASH));
        ...
        const p1 = new _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["Parameter"]('from', _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["ParameterType"].ByteArray, addr.serialize());
        const p2 = new _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["Parameter"]('to', _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["ParameterType"].ByteArray, recv.serialize());
        const p3 = new _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["Parameter"]('value', _smartcontract_abi_parameter__WEBPACK_IMPORTED_MODULE_15__["ParameterType"].Integer, amount * NEO_TRAN);
        ...
        return _neocore_NeoRpc__WEBPACK_IMPORTED_MODULE_8__["NeoRpc"].sendRawTransaction(NEO_NODE, tx.serialize()).then(res => {
            ...
            if (res.result) {
                result.result = Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(tx.getHash());
                callback && Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(result), callback);
            } else {
    ...
    static getNeoBalance(address, callback) {
        ...
        return _neocore_NeoRpc__WEBPACK_IMPORTED_MODULE_8__["NeoRpc"].getBalance(NEO_NODE, contractAddr, addr).then(res => {
            ...
            if (res.result) {
                const balance = parseInt(Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(res.result), 16);
    ...
    static queryOep8Balance(contractHash, account, tokenId, callback) {
        const contractAddr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(contractHash));
        const oep8 = new _smartcontract_neovm_oep8TxBuilder__WEBPACK_IMPORTED_MODULE_18__["Oep8TxBuilder"](contractAddr);
        ...
        return SDK.restClient.sendRawTransaction(tx.serialize(), true).then(res => {
            ...
            if (res.Result.Result) {
                result.result = parseInt(Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(res.Result.Result), 16);
            }
            callback && Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(result), callback);
            return result;
        });
    ...
    static queryOep8Balances(contractHash, account, callback) {
        ...
        return SDK.restClient.sendRawTransaction(tx.serialize(), true).then(res => {
            ...
            if (res.Result.Result) {
                const vals = res.Result.Result.map(v => v ? parseInt(Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(v), 16) : 0);
                result.result = vals;
            }
            callback && Object(_utils__WEBPACK_IMPORTED_MODULE_22__["sendBackResult2Native"])(JSON.stringify(result), callback);
            return result;
    ...
    static queryOep4Balance(contractHash, account, callback) {
        const contractAddr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](Object(_utils__WEBPACK_IMPORTED_MODULE_22__["reverseHex"])(contractHash));
        const oep4 = new _smartcontract_neovm_oep4TxBuilder__WEBPACK_IMPORTED_MODULE_25__["Oep4TxBuilder"](contractAddr);
        const addr = new _crypto__WEBPACK_IMPORTED_MODULE_5__["Address"](account);
...
SDK.socketClient = new _network_websocket_websocketClient__WEBPACK_IMPORTED_MODULE_12__["WebsocketClient"]();
...
/* harmony import */ var _transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../transaction/transactionUtils */ "./src/transaction/transactionUtils.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils */ "./src/utils.ts");
...
function makeRegisterCandidateTx(ontid, peerPubKey, keyNo, userAddr, initPos, payer, gasPrice, gasLimit) {
    ...
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('registerCandidate', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
 *
...
function makeUnregisterCandidateTx(userAddr, peerPubKey, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('unRegisterCandidate', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeApproveCandidateTx(peerPubKey, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('approveCandidate', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeRejectCandidateTx(peerPubKey, payer, gasPrice, gasLimit) {
    ...
    struct.add(Object(_utils__WEBPACK_IMPORTED_MODULE_6__["str2hexstr"])(peerPubKey));
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('rejectCandidate', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeVoteForPeerTx(userAddr, peerPubKeys, posList, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('voteForPeer', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeUnvoteForPeerTx(userAddr, peerPubKeys, posList, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('unVoteForPeer', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeWithdrawTx(userAddr, peerPubKeys, withdrawList, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('withdraw', params, contractAddress, gasPrice, gasLimit, payer);
}
/** Quit node register
 * Need two signatures if userAddr and payer are not the same
 */
function makeQuitNodeTx(userAddr, peerPubKey, payer, gasPrice, gasLimit) {
    ...
    struct.add(Object(_utils__WEBPACK_IMPORTED_MODULE_6__["str2hexstr"])(peerPubKey), userAddr.serialize());
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('quitNode', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeChangeAuthorizationTx(peerPubKey, userAddr, maxAuthorize, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('changeMaxAuthorization', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeSetPeerCostTx(peerPubKey, userAddr, peerCost, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('setPeerCost', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeWithdrawFeeTx(userAddr, payer, gasPrice, gasLimit) {
    ...
    struct.add(userAddr.serialize());
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('withdrawFee', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeAuthorizeForPeerTx(userAddr, peerPubKeyList, posList, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('authorizeForPeer', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeUnauthorizeForPeerTx(userAddr, peerPubKeyList, posList, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('unAuthorizeForPeer', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeAddInitPosTx(peerPubkey, userAddr, pos, payer, gasPrice, gasLimit) {
    ...
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('addInitPos', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
function makeReduceInitPosTx(peerPubkey, userAddr, pos, payer, gasPrice, gasLimit) {
    ...
    struct.add(Object(_utils__WEBPACK_IMPORTED_MODULE_6__["str2hexstr"])(peerPubkey), userAddr.serialize(), pos);
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('reduceInitPos', params, contractAddress, gasPrice, gasLimit, payer);
}
function makeWithdrawPeerUnboundOngTx(userAddr, payer, gasPrice, gasLimit) {
    const struct = new _abi_struct__WEBPACK_IMPORTED_MODULE_8__["default"]();
    struct.add(userAddr.serialize());
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_7__["buildNativeCodeScript"])([struct]);
    return Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_5__["makeNativeContractTx"])('withdrawOng', params, contractAddress, gasPrice, gasLimit, payer);
}
/**
...
/*!*********************************************************!*\
  !*** ./src/smartcontract/nativevm/ontAssetTxBuilder.ts ***!
  \*********************************************************/
/*! exports provided: ONT_CONTRACT, ONG_CONTRACT, getTokenContract, verifyAmount, makeTransferTx, makeTransferToMany, makeWithdrawOngTx, makeQueryAllowanceTx, makeQueryBalanceTx, deserializeTransferTx */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeTransferToMany", function() { return makeTransferToMany; });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils */ "./src/utils.ts");
/* harmony import */ var _transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../transaction/transactionUtils */ "./src/transaction/transactionUtils.ts");
...
function makeTransferTx(tokenType, from, to, amount, gasPrice, gasLimit, payer) {
    ...
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_7__["makeNativeContractTx"])('transfer', params, contract, gasPrice, gasLimit);
 ...
 * @param amounts
 */
function makeTransferToMany(tokenType, from, to, amounts, gasPrice, gasLimit) {
    ...
    for (let i = 0; i < to.length; i++) {
        verifyAmount(amounts[i]);
        const s = new _abi_struct__WEBPACK_IMPORTED_MODULE_9__["default"]();
        s.add(from, to[i], new bignumber_js__WEBPACK_IMPORTED_MODULE_0__["BigNumber"](amounts[i]));
        structs.push(s);
    }
    const list = [];
    list.push(structs);
...
function makeWithdrawOngTx(from, to, amount, payer, gasPrice, gasLimit) {
    ...
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_7__["makeNativeContractTx"])('transferFrom', args, new _crypto__WEBPACK_IMPORTED_MODULE_3__["Address"](ONG_CONTRACT), gasPrice, gasLimit);
    tx.payer = payer;
    tx.tokenType = 'ONG';
    tx.from = from;
    tx.to = to;
...
function makeQueryAllowanceTx(asset, from, to) {
    ...
    list.push(struct);
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_8__["buildNativeCodeScript"])(list);
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_7__["makeNativeContractTx"])('allowance', params, new _crypto__WEBPACK_IMPORTED_MODULE_3__["Address"](contract), '0', '0');
    return tx;
}
/**
...
function makeQueryBalanceTx(asset, address) {
    ...
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_7__["makeNativeContractTx"])('balanceOf', params, new _crypto__WEBPACK_IMPORTED_MODULE_3__["Address"](contract), '0', '0');
    return tx;
}
...
/* harmony import */ var _crypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../crypto */ "./src/crypto/index.ts");
/* harmony import */ var _transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../transaction/transactionUtils */ "./src/transaction/transactionUtils.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils */ "./src/utils.ts");
...
function buildRegisterOntidTx(ontid, publicKey, gasPrice, gasLimit, payer) {
    ...
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_1__["makeNativeContractTx"])(method, params, new _crypto__WEBPACK_IMPORTED_MODULE_0__["Address"](ONTID_CONTRACT), gasPrice, gasLimit, payer);
    return tx;
}
/**
...
function buildGetAttributesTx(ontid) {
    ...
    struct.add(ontid);
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_3__["buildNativeCodeScript"])([struct]);
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_1__["makeNativeContractTx"])(method, params, new _crypto__WEBPACK_IMPORTED_MODULE_0__["Address"](ONTID_CONTRACT));
    return tx;
}
/**
...
function buildChangeRecoveryTx(ontid, newrecovery, oldrecovery, gasPrice, gasLimit, payer) {
    ...
    struct.add(p1, p2, p3);
    const params = Object(_abi_nativeVmParamsBuilder__WEBPACK_IMPORTED_MODULE_3__["buildNativeCodeScript"])([struct]);
    const tx = Object(_transaction_transactionUtils__WEBPACK_IMPORTED_MODULE_1__["makeNativeContractTx"])(method, params, new _crypto__WEBPACK_IMPORTED_MODULE_0__["Address"](ONTID_CONTRACT), gasPrice, gasLimit);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils */ "./src/utils.ts");
/* harmony import */ var _opcode__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./opcode */ "./src/transaction/opcode.ts");
/* harmony import */ var _payload_deployCode__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./payload/deployCode */ "./src/transaction/payload/deployCode.ts");
/* harmony import */ var _payload_invokeCode__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./payload/invokeCode */ "./src/transaction/payload/invokeCode.ts");
/* harmony import */ var _program__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./program */ "./src/transaction/program.ts");
/* harmony import */ var _scriptBuilder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./scriptBuilder */ "./src/transaction/scriptBuilder.ts");
/* harmony import */ var _transaction__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./transaction */ "./src/transaction/transaction.ts");
/* harmony import */ var _smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../smartcontract/nativevm/ontAssetTxBuilder */ "./src/smartcontract/nativevm/ontAssetTxBuilder.ts");
/* harmony import */ var _smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../smartcontract/nativevm/ontidContractTxBuilder */ "./src/smartcontract/nativevm/ontidContractTxBuilder.ts");
/* harmony import */ var _txSignature__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./txSignature */ "./src/transaction/txSignature.ts");
/*
 * Copyright (C) 2018 The ontology Authors
 * This file is part of The ontology library.
 *
...
const signTransaction = (tx, privateKey, schema) => {
    const signature = _txSignature__WEBPACK_IMPORTED_MODULE_16__["TxSignature"].create(tx, privateKey, schema);
    tx.sigs = [signature];
};
/**
...
const signTransactionAsync = async (tx, privateKey, schema) => {
    const signature = await _txSignature__WEBPACK_IMPORTED_MODULE_16__["TxSignature"].createAsync(tx, privateKey, schema);
    tx.sigs = [signature];
};
/**
 * Signs the transaction object.
...
const equalPks = (pks1, pks2) => {
    ...
    pks1.sort(_program__WEBPACK_IMPORTED_MODULE_11__["comparePublicKeys"]);
    pks2.sort(_program__WEBPACK_IMPORTED_MODULE_11__["comparePublicKeys"]);
...
const signTx = (tx, M, pubKeys, privateKey, scheme) => {
    ...
    const sig = new _txSignature__WEBPACK_IMPORTED_MODULE_16__["TxSignature"]();
    sig.M = M;
    sig.pubKeys = pubKeys;
...
const makeInvokeTransaction = (funcName, params, contractAddr, gasPrice, gasLimit, payer) => {
    const tx = new _transaction__WEBPACK_IMPORTED_MODULE_13__["Transaction"]();
    tx.type = _transaction__WEBPACK_IMPORTED_MODULE_13__["TxType"].Invoke;
    let args = '';
    if (typeof params === 'string') {
        args = params;
    } else {
        const abiFunc = new _smartcontract_abi_abiFunction__WEBPACK_IMPORTED_MODULE_5__["default"](funcName, '', params);
        args = Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_12__["serializeAbiFunction"])(abiFunc);
    }
    let code = args + Object(_utils__WEBPACK_IMPORTED_MODULE_7__["num2hexstring"])(_opcode__WEBPACK_IMPORTED_MODULE_8__["default"].APPCALL);
    code += contractAddr.serialize();
    const payload = new _payload_invokeCode__WEBPACK_IMPORTED_MODULE_10__["default"]();
    payload.code = code;
    tx.payload = payload;
    if (gasLimit) {
...
function makeDeployCodeTransaction(code, name = '', codeVersion = '1.0', author = '', email = '', desp = '', needStorage = true, gasPrice, gasLimit, payer) {
    const dc = new _payload_deployCode__WEBPACK_IMPORTED_MODULE_9__["default"]();
    dc.author = author;
    ...
    tx.version = 0x00;
    tx.payload = dc;
    tx.type = _transaction__WEBPACK_IMPORTED_MODULE_13__["TxType"].Deploy;
    // gas
...
function buildParamsByJson(json) {
    ...
    for (const obj of functions) {
        ...
        const list = [];
        list.push(Object(_utils__WEBPACK_IMPORTED_MODULE_7__["str2hexstr"])(operation));
        const temp = [];
...
function makeTransactionsByJson(json) {
    ...
    const contractAddr = new _crypto__WEBPACK_IMPORTED_MODULE_2__["Address"](Object(_utils__WEBPACK_IMPORTED_MODULE_7__["reverseHex"])(contractHash));
    ...
    if (contractHash.indexOf('00000000000000000000000000000000000000') > -1) {
        ...
        for (const list of parameters) {
            const params = Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_12__["createCodeParamsScript"])(list);
...
function buildNativeTxFromJson(json) {
    ...
    if (json.contractHash.indexOf('02') > -1 || json.contractHash.indexOf('01') > -1) {
        ...
        if (funcArgs.operation === 'transfer') {
            ...
            const tx = Object(_smartcontract_nativevm_ontAssetTxBuilder__WEBPACK_IMPORTED_MODULE_14__["makeTransferTx"])(tokenType, from, to, amount, json.gasPrice, json.gasLimit, payer);
            return tx;
        }
        ...
        if (funcArgs.operation === 'regIDWithPublicKey') {
            ...
            const payer = new _crypto__WEBPACK_IMPORTED_MODULE_2__["Address"](json.payer);
            const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_15__["buildRegisterOntidTx"])(ontid, pk, json.gasPrice, json.gasLimit, payer);
            return tx;
        } else if (funcArgs.operation === 'getDDO') {
            const ontid = args[0].value.substr(args[0].value.indexOf(':') + 1);
            const tx = Object(_smartcontract_nativevm_ontidContractTxBuilder__WEBPACK_IMPORTED_MODULE_15__["buildGetDDOTx"])(ontid);
            return tx;
        }
    }
}
...
/*!*********************************************!*\
  !*** ./src/transaction/transactionUtils.ts ***!
  \*********************************************/
/*! exports provided: makeNativeContractTx */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../consts */ "./src/consts.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./src/utils.ts");
/* harmony import */ var _opcode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./opcode */ "./src/transaction/opcode.ts");
/* harmony import */ var _payload_invokeCode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./payload/invokeCode */ "./src/transaction/payload/invokeCode.ts");
/* harmony import */ var _scriptBuilder__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scriptBuilder */ "./src/transaction/scriptBuilder.ts");
/* harmony import */ var _transaction__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transaction */ "./src/transaction/transaction.ts");
/* harmony import */ var _transfer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./transfer */ "./src/transaction/transfer.ts");
...
function makeNativeContractTx(funcName, params, contractAddr, gasPrice, gasLimit, payer) {
    let code = '';
    code += params;
    code += Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_5__["pushHexString"])(Object(_utils__WEBPACK_IMPORTED_MODULE_2__["str2hexstr"])(funcName));
    code += Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_5__["pushHexString"])(contractAddr.serialize());
    code += Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_5__["pushInt"])(0);
    code += Object(_utils__WEBPACK_IMPORTED_MODULE_2__["num2hexstring"])(_opcode__WEBPACK_IMPORTED_MODULE_3__["default"].SYSCALL);
    code += Object(_scriptBuilder__WEBPACK_IMPORTED_MODULE_5__["pushHexString"])(Object(_utils__WEBPACK_IMPORTED_MODULE_2__["str2hexstr"])(_consts__WEBPACK_IMPORTED_MODULE_1__["NATIVE_INVOKE_NAME"]));
    const payload = new _payload_invokeCode__WEBPACK_IMPORTED_MODULE_4__["default"]();
    payload.code = code;
    let tx;
    if (funcName === 'transfer' || funcName === 'transferFrom') {
        tx = new _transfer__WEBPACK_IMPORTED_MODULE_7__["Transfer"]();
    } else {
        tx = new _transaction__WEBPACK_IMPORTED_MODULE_6__["Transaction"]();
    }
    tx.type = _transaction__WEBPACK_IMPORTED_MODULE_6__["TxType"].Invoke;
    tx.payload = payload;
    if (gasLimit) {
        tx.gasLimit = new _common_fixed64__WEBPACK_IMPORTED_MODULE_0__["default"](gasLimit);
    }
...
module.exports = require("base-58");
